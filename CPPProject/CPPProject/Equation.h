...
class Equation
{
	...
	bool IsInteger(int dividend, int divisor){ return (dividend % divisor == 0); } // this function checks if a caluclated solution posability is an integer
	bool IsSolutionInRange(int num){ return (num > 0 && num <= (currentLevel + 10)); };
