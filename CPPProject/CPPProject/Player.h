...
public:
	Player(const char& ch, const string& str, const Point& p, const Direction::value& d) : MovingScreenObject(p, d, ch), playerChar(ch), keyboardKeys(str), score(0), playerSolved(false), bullets(NUM_OF_BULLETS)
	{
